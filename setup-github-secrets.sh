...
echo "1. Generate an SSH key pair if you don't already have one:"
echo "   ssh-keygen -t rsa -b 4096 -C 'your_email@example.com'"
echo ""
echo "2. Add the public key as a GitHub secret named SSH_PUBLIC_KEY:"
if [ "$MANUAL_SETUP" = false ]; then
    ...
    echo "   a. Go to your GitHub repository: https://github.com/$GITHUB_USERNAME/$REPO_NAME"
    echo "   b. Navigate to Settings > Secrets and variables > Actions"
    echo "   c. Click on 'New repository secret'"
    echo "   d. Name: SSH_PUBLIC_KEY"
    echo "   e. Value: (Copy the contents of your ~/.ssh/id_rsa.pub file)"
fi
echo ""
echo "The GitHub Actions workflow is already configured to use this secret if it exists."
